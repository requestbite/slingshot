 ...
 *
 * @param {Object} props
 * @param {string} [props.variant='primary'] - Button variant: 'primary', 'secondary', 'ghost', 'icon', 'danger', 'utility', 'success'
...
export function Button({
  ...
  const baseClasses = 'inline-flex items-center justify-center rounded-md font-semibold focus-visible:outline focus-visible:outline-offset-2 transition-colors cursor-pointer';
