...
export function Button({
  ...
  const variantClasses = {
    ...
    icon: 'bg-sky-100 dark:bg-sky-200 text-sky-700 hover:bg-sky-200 dark:hover:bg-sky-300 focus-visible:outline-sky-500 disabled:opacity-50 disabled:cursor-not-allowed',
