 ...
 *
 * @param {Object} props
 * @param {string} [props.variant='primary'] - Button variant: 'primary', 'secondary', 'ghost', 'icon', 'danger', 'utility', 'success', 'none'
...
export function Button({
  ...
  const baseClasses = `inline-flex items-center justify-center rounded-md ${fontWeight} focus-visible:outline focus-visible:outline-offset-2 transition-colors cursor-pointer`;
