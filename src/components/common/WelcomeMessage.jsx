  ...
  return (
    <div class="text-center py-8 flex flex-col items-center justify-center h-full">
      ...
      <div class="mt-6 flex items-center justify-center w-8 h-8 mx-auto text-white bg-linear-to-b from-orange-300 to-orange-400 hover:from-orange-400 hover:to-orange-500 font-bold rounded-full outline-1 outline-orange-300 border-2">
        1 </div>
      <div class="w-px h-4 bg-gray-300 dark:bg-neutral-dark-50"></div>
      <div class="bg-gray-50 dark:bg-neutral-dark-200 px-2 py-1 text-gray-500 dark:text-neutral-dark-500 text-sm rounded-md border border-gray-200 dark:border-neutral-dark-300">
      ...
      <div class="bg-gray-50 dark:bg-neutral-dark-200 px-2 py-1 text-gray-500 dark:text-neutral-dark-500 text-sm rounded-md border border-gray-200 dark:border-neutral-dark-300">
        <button
          ...
          class="text-gray-400 dark:text-neutral-dark-400 underline bg-transparent border-none p-0 cursor-pointer hover:text-gray-500 dark:hover:text-neutral-dark-500"
        >
          Import
      ...
      <div class="w-px h-4 bg-gray-300 dark:bg-neutral-dark-50"></div>
      <div class="bg-gray-50 dark:bg-neutral-dark-200 px-2 py-1 text-gray-500 dark:text-neutral-dark-500 text-sm rounded-md border border-gray-200 dark:border-neutral-dark-300">
        <a href="https://docs.requestbite.com/slingshot/slingshot/" target="_blank" class="text-gray-500 dark:text-neutral-dark-500 hover:text-gray-400 dark:hover:text-neutral-dark-400 hover:underline flex items-center">
          Read the docs
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ml-1">
            <path d="M15 3h6v6"></path>
            <path d="M10 14 21 3"></path>
