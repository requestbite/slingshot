 ...
 * - Text, password, and URL input types
  ...
  return (
    <div class="relative w-full">
      <input
        ...
        disabled={disabled}
        required={required}
        class={`block w-full rounded-md px-3 py-1.5 text-gray-900 outline focus:outline-2 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:-outline-offset-2 focus:outline-sky-500 text-sm/6 ${rightPadding} ${className}`}
        {...props}
      />
