...
export function PostmanImportModal({ isOpen, onClose, onSuccess }) {
  ...
  const validateFile = (file) => {
    ...
    // Check file type - only JSON for Postman collections
              ...
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  <div class="text-center mt-0 sm:text-left">
                    <h3 class="text-base font-semibold text-gray-900">Import Postman Collection</h3>
                    <div class="mt-2 text-sm text-gray-500">Import a Postman Collection v2.1 file to create new collection.</div>
                    ...
                    <div class="mt-6">
                      ...
                      <p class="text-xs text-gray-500 mb-3">
                        If left empty, the name will be taken from the Postman collection.
                      </p>

                      <label for="postman-file" class="block text-left text-sm font-medium text-gray-700 mb-1">Postman Collection file (JSON)</label>
                      <input
                        ref={fileInputRef}
                        type="file"
                        id="postman-file"
