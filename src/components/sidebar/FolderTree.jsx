  ...
  if (isLoading) {
    return (
      <div class="flex items-center justify-center py-8">
        <div class="flex items-center space-x-2 text-gray-500 dark:text-neutral-dark-500">
      ...
      <div class="text-center py-6 text-gray-500 dark:text-neutral-dark-500">
        {hasSearchTerm ? (
          ...
          <>
            ...
            <p class="text-xs mt-1 text-gray-400 dark:text-neutral-dark-400">Import an OpenAPI spec or add folders</p>
          </>
        )}
      </div>
    );
