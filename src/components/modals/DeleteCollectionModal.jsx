      ...
      >
        <div class="px-6 py-4 border-b border-gray-200">
          <div class="flex items-center space-x-3">
            ...
            <div>
              <h2 class="text-lg font-semibold text-gray-900">Delete Collection</h2>
        ...
        <div class="px-6 py-4">
          <div class="space-y-4">
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-md p-3">
              <div class="text-xs text-gray-500 mb-2">Collection Details</div>
              <div class="space-y-2">
                <div class="flex items-center justify-between text-sm">
                  <span class="text-gray-600">Requests:</span>
                  <span class="font-medium text-gray-900">{collection.request_count || 0}</span>
                </div>
                <div class="flex items-center justify-between text-sm">
                  <span class="text-gray-600">Secrets/Variables:</span>
                  <span class="font-medium text-gray-900">{collection.secret_count || 0}</span>
                </div>
                {collection.description && (
                  <div class="text-sm">
                    <span class="text-gray-600">Description:</span>
                    <p class="text-gray-900 mt-1">{collection.description}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div class="bg-red-50 border border-red-200 rounded-md p-3">
              <div class="flex items-start space-x-2">
                ...
                <div class="text-sm text-red-700">
                  <p class="font-medium">Warning: This will permanently delete:</p>
                  <ul class="mt-1 list-disc list-inside space-y-1">
                    <li>All folders and subfolders in this collection</li>
                    <li>All requests and their saved responses</li>
                    <li>All collection-specific secrets and variables</li>
