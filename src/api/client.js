...
export class SlingshotApiClient {
  ...
  async createCollection(collectionData) {
    ...
    const collection = {
      ...
      source_openapi_url: collectionData.source_openapi_url || null
    };
  ...
  async createRequest(requestData) {
    ...
    const request = {
      ...
      // OpenAPI metadata fields (optional, safe for null/undefined)
      description: requestData.description !== undefined ? requestData.description : null,
      summary: requestData.summary !== undefined ? requestData.summary : null,
      operation_id: requestData.operation_id !== undefined ? requestData.operation_id : null,
  ...
  async duplicateRequest(id) {
    ...
    const duplicateData = {
      ...
      // Copy OpenAPI metadata if present
   ...
   * @returns {Promise<import('../types/index.js').Request>} Updated request
   */
  async clearRequestResponseAndDrafts(id) {
    const existing = await db.requests.get(id);
    if (!existing) {
      throw new Error('Request not found');
    }
